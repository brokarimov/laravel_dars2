                        ...
                        <div class="item-banner style1">
                            <div class="inner equal-element">
                                <div class="banner-content style1">
                                    <h4 class="vereesa-subtitle">Start ur weekend off right!</h4>
                                    <h3 class="title">Chairs Sale<br/> 15% OFF</h3>
                                    <span class="when-code">When Use Code: <span class="code">VEREESA</span></span>
                        ...
                        <div class="item-banner style2">
                            <div class="inner equal-element">
                                <div class="banner-content style2">
                                    <h3 class="title">Little America™ Lamp</h3>
                                    <span class="description">Suit your style with our new<br/> Lamp collection</span>
