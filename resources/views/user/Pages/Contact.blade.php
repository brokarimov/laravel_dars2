...
<div class="main-content main-content-contact">
    ...
    <div class="page-main-content">
        <div class="google-map">
            <div class="vereesa-google-maps" id="vereesa-google-maps" data-hue="" data-lightness="1" data-map-style="2"
                    ...
                    <div class="form-contact">
                        <div class="col-lg-8 no-padding">
                            <div class="form-message">
                                ...
                                <form action="#" class="vereesa-contact-fom">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <p>
                        ...
                        <div class="col-lg-4 no-padding">
                            <div class="form-contact-information">
                                <form action="#" class="vereesa-contact-info">
                                    <h2 class="title">
                                        Contact information
                                    </h2>
                                    <div class="info">
