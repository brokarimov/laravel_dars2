            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Ovqat</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    ...
                    @endif
                    <a href="/ovqat-create" class="btn btn-primary">Create</a>
                    <div class="card mt-2">
                            ...
                            <table id="" class="table table-bordered table-striped mt-2">
                                <thead>
                                    <tr>
                                        <th>Id</th>
                                        <th>Name</th>
                                        <th>Masalliq count</th>
                                        <th>Options</th>
                                    </tr>
                                </thead>
                                <tbody id="ovqatTableBody">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    ...
                                                    <a href="/ovqat-update/{{$model->id}}"
                                                        class="btn btn-warning mx-2">Update</a>

                                                    <form action="/ovqat/{{$model->id}}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
